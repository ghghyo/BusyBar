        ...
        <div className="row justify-content-center">
          <div className="col-12 col-xl-6">
            <div className="section__header">
              <h2 className="h2">frequently ask questions</h2> {/* top section add more pictures, instruct ai section move above reviews, unlock the best day and night can be second section, people then reviews then forms, call out the first 1000 users in the forms*/}
            </div>
          </div>
        </div>
        <div className="row justify-content-center">
